...
function registerProviders(extensionContext) {
    ...
    extensionContext.subscriptions.push(vscode.window.registerWebviewViewProvider('latex-workshop-math-symbols', lw_1.lw.extra.snippet.provider, { webviewOptions: { retainContextWhenHidden: true } }));
}
