...
lw_1.lw.watcher.glossary.onCreate(uri => parseBibFile(uri.fsPath));
lw_1.lw.watcher.glossary.onChange(uri => parseBibFile(uri.fsPath));
lw_1.lw.watcher.glossary.onDelete(uri => removeEntriesInFile(uri.fsPath));
