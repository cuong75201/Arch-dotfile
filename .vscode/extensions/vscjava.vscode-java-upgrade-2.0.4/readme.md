...
**GitHub Copilot modernization - upgrade for Java** helps you upgrade your Java applications. It's an extension for Visual Studio Code which can help:
...
Modernization isn’t complete until your application builds successfully. GitHub Copilot modernization - upgrade for Java executes tools like open-source tools like [OpenRewrite](https://docs.openrewrite.org/) to apply code transformations, automatically resolve build issues, and run test validations — ensuring a smooth, error-free upgrade process.
...
In addition to Java upgrade, GitHub Copilot modernization - upgrade for Java can also help generate unit test cases separately to boost the unit test coverage.
